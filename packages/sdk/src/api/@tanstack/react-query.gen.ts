 ...
 */
export const adminRestoreTaskV1TasksTaskIdRestorePostMutation = (options?: Partial<Options<AdminRestoreTaskV1TasksTaskIdRestorePostData>>): UseMutationOptions<AdminRestoreTaskV1TasksTaskIdRestorePostResponse, AdminRestoreTaskV1TasksTaskIdRestorePostError, Options<AdminRestoreTaskV1TasksTaskIdRestorePostData>> => {
    const mutationOptions: UseMutationOptions<AdminRestoreTaskV1TasksTaskIdRestorePostResponse, AdminRestoreTaskV1TasksTaskIdRestorePostError, Options<AdminRestoreTaskV1TasksTaskIdRestorePostData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await adminRestoreTaskV1TasksTaskIdRestorePost({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
