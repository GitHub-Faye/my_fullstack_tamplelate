 ...
 * PM 接手竞价任务为执行人
 *
 * PM 将自己发布的竞价中任务直接接管执行，跳过竞价流程。任务状态变为进行中，不参与星点/薪资计算。
 */
export const selfAssignTaskV1TasksTaskIdSelfAssignPostMutation = (options?: Partial<Options<SelfAssignTaskV1TasksTaskIdSelfAssignPostData>>): UseMutationOptions<SelfAssignTaskV1TasksTaskIdSelfAssignPostResponse, SelfAssignTaskV1TasksTaskIdSelfAssignPostError, Options<SelfAssignTaskV1TasksTaskIdSelfAssignPostData>> => {
    const mutationOptions: UseMutationOptions<SelfAssignTaskV1TasksTaskIdSelfAssignPostResponse, SelfAssignTaskV1TasksTaskIdSelfAssignPostError, Options<SelfAssignTaskV1TasksTaskIdSelfAssignPostData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await selfAssignTaskV1TasksTaskIdSelfAssignPost({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 * PM 完成自领任务
 *
 * PM 标记自领任务为完成。该任务不参与星点/薪资计算。
 */
export const selfCompleteTaskV1TasksTaskIdSelfCompletePostMutation = (options?: Partial<Options<SelfCompleteTaskV1TasksTaskIdSelfCompletePostData>>): UseMutationOptions<SelfCompleteTaskV1TasksTaskIdSelfCompletePostResponse, SelfCompleteTaskV1TasksTaskIdSelfCompletePostError, Options<SelfCompleteTaskV1TasksTaskIdSelfCompletePostData>> => {
    const mutationOptions: UseMutationOptions<SelfCompleteTaskV1TasksTaskIdSelfCompletePostResponse, SelfCompleteTaskV1TasksTaskIdSelfCompletePostError, Options<SelfCompleteTaskV1TasksTaskIdSelfCompletePostData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await selfCompleteTaskV1TasksTaskIdSelfCompletePost({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
