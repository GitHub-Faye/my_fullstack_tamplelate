 ...
 * 管理员工资管理页面
 *
 * 展示：筛选（月份、人员）+ 工程师/PM 工资标签页 + 导出按钮
 * TODO: 集成实际工资 API 后替换静态数据
 */
            ...
            <div className="flex gap-1 bg-muted rounded-lg p-1">
              <button
                className={`px-3 py-1 text-sm rounded-md transition-colors ${
                  tab === "engineer" ? "bg-background shadow-sm" : "hover:bg-background/50"
                }`}
              ...
              <button
                className={`px-3 py-1 text-sm rounded-md transition-colors ${
                  tab === "pm" ? "bg-background shadow-sm" : "hover:bg-background/50"
                }`}
                onClick={() => setTab("pm")}
              >
                市场产品PM
