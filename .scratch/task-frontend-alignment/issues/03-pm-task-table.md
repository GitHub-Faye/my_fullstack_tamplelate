...
- [x] 资料变更操作路由到编辑页面 ✅ 已确认：`getPmActions` 中 `changeDoc` 已定义，`handleAction` 已路由到 `/pm/tasks/${task.id}/edit`
- [x] 表格列顺序与原型一致 ✅ 已确认：任务、发布人、类型、工程师、预期上线、T报完成时间、当前阶段/进度、状态、操作（9列与原型完全一致）